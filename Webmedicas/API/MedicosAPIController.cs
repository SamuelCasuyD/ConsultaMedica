    ...
    public class MedicosAPIController : ApiController
    {
        ...
        public Models.RespuestaDTO CrearRegistroMedico(Models.MedicoDTO value)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("SP_DatosMedicos", connection))
            {
                ...
                cmd.Parameters.AddWithValue("param7", value.Eliminado);
                cmd.Parameters.AddWithValue("param8", value.Estado);
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        respuesta.Mensaje = (a == 0) ? "No se pudo crear el Medico" : "Creación exitosa";
                    }
                    catch (Exception ex)
                    {
